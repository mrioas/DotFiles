...
Options.add_argument("high-dpi-support=0.80")
...
driver.get("http://172.18.14.126/Orion/SummaryView.aspx?ViewID=1")
...
click = driver.find_element(By.ID, "ctl00_BodyContent_LoginButton").click()
